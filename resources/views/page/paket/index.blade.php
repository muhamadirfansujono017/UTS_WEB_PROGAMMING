                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 flex gap-5">
                    ...
                    <div class="w-full bg-gray-900 p-4 rounded-xl">
                        ...
                        <form action="{{ route('paket.store') }}" method="post">
                            ...
                            <div class="mb-5">
                                <label for="id_outlet"
                                    class="block mb-2 text-sm font-medium text-gray-white dark:text-blak">Id Outlet</label>
                            ...
                            <div class="">
                                <label for="base-input"
                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-blak">Jenis</label>
                                <select class="js-example-placeholder-single js-states form-control w-full m-6"
                            ...
                            <div class="mb-5">
                                <label for="base-input"
                                    class="block mb-2 text-sm font-medium text-gray-200 dark:text-blak">Nama Paket</label>
                                <input name="nama_paket" type="text" id="base-input"
                                    class="bg-gray-50 border border-gray-900 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-900 dark:focus:border-blue-500"
